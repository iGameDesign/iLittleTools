...
g_DstPath       = r"emptyproject_logic"
...
def AddScripts(projfile, scripts):
    ...
    open(projfile[:-len(".template")], 'w').write(content % (g_Macro, "\n\t".join(lines)))
...
if __name__ == "__main__":
    ...
    if args.d:
        ...
        content = open(srcprojfile, 'r').read()
        regx = re.compile(r"<DefineConstants>(.+)</DefineConstants>")
