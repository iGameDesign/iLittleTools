...
FileName        : buildAssetBundle4ScriptsDll.py
Creator         : pengpeng
Date            : 2014-12-25 11:11
Comment         : 
ModifyHistory   :
Description     : 1. 编码转换; 2. 生成meta文件
...
g_TestSuite         = r"buildAssetBundle4ScriptsDll"
g_RootPath          = r"E:\workspace\gunsoul_mobile\game\project\game-xx"
g_ScriptsDllPath    = r"Assets\resourcex\gamelogic"
g_ScriptsDllFile    = r"Assembly-CSharpImpl.bytes"

g_LogFile           = r"logs\buildAssetBundle4ScriptsDll.log"
